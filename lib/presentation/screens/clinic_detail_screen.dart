...
class _ClinicDetailScreenState extends ConsumerState<ClinicDetailScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoCard(
                    ...
                    subtitle: clinic.openingHours != null
                        ? _getOpenClosedStatus(clinic.openingHours!)
                        : null,
                    subtitleColor: isOpen
                        ? AppColors.accentGreen
                        : AppColors.errorRed,
                  ),
                      ...
                      if (clinic.phone != null && clinic.phone!.isNotEmpty)
                        Expanded(
                          child: ElevatedButton.icon(
                            onPressed: () =>
                                launchUrl(Uri.parse('tel:${clinic.phone}')),
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {
                        final url =
                            'https://www.openstreetmap.org/?mlat=${clinic.latitude}&mlon=${clinic.longitude}#map=18/${clinic.latitude}/${clinic.longitude}';
                        launchUrl(
                          Uri.parse(url),
                          mode: LaunchMode.externalApplication,
                        );
      ...
      bottomNavigationBar: Container(
        ...
        child: ElevatedButton(
          onPressed: () {
            ...
            ref.read(bookingProvider.notifier).selectClinic(clinicModel);
  ...
  bool _isOpenNow(String? openingHours) {
    ...
    if (timePattern.hasMatch(openingHours)) {
      ...
      final allTimes = timePattern
          .allMatches(openingHours)
          .map((m) => m.group(0)!)
          .toList();
