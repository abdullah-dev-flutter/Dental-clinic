...
class AppBottomNav extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    int currentIndex = 0;
    if (location.startsWith('/services')) currentIndex = 1;
    if (location.startsWith('/profile')) currentIndex = 2;
    if (location.startsWith('/doctors')) currentIndex = 3;
    if (location.startsWith('/schedule')) currentIndex = 4;
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          selectedItemColor: AppColors.accentGreen, // Add this line
          ...
          items: [
            ...
            _buildNavItem(Icons.medical_services, 'Services', 1, currentIndex),
            profileState.when(
            ...
            _buildNavItem(Icons.people, 'Doctors', 3, currentIndex),
            _buildNavItem(Icons.calendar_month, 'Schedule', 4, currentIndex),
          ],
        ),
      ),
    );
