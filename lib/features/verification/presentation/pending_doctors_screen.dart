...
class PendingDoctorsScreen extends ConsumerWidget {
          ...
          Row(
            ...
            children: [
              ...
              IconButton(
                ...
                onPressed: () => ref.invalidate(pendingDoctorsProvider),
              ),
            ],
          ),
          ...
          Expanded(
            child: Container(
              ...
              child: pendingAsync.when(
                data: (doctors) {
                  if (doctors.isEmpty) {
                    return const Center(child: Text('No pending applications.', style: TextStyle(color: Colors.grey, fontSize: 16)));
                  }
